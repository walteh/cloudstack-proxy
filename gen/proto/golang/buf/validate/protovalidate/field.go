...
// This code is a copy of the field.go file in the bufbuild/protovalidate-go repository.
// The only modification is to the import path to use a local path.
//
// Release Tag: v0.9.3
// Source: https://raw.githubusercontent.com/bufbuild/protovalidate-go/refs/tags/v0.9.3/field.go
// ================= protoc-gen-protovalidate =================
