...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/walteh/cloudstack-proxy/gen/proto/golang/cloudstack/vpc/v1"
	http "net/http"
	strings "strings"
)
...
func NewVPCServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) VPCServiceClient {
	...
	vPCServiceMethods := v1.File_cloudstack_vpc_v1_vpc_sample_proto.Services().ByName("VPCService").Methods()
