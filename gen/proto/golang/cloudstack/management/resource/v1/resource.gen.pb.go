...
func (x *Result) Reset() {
	*x = Result{}
	mi := &file_cloudstack_management_resource_v1_resource_gen_proto_msgTypes[37]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Result) Descriptor() ([]byte, []int) {
	return file_cloudstack_management_resource_v1_resource_gen_proto_rawDescGZIP(), []int{37}
}
...
const file_cloudstack_management_resource_v1_resource_gen_proto_rawDesc = "" +
	...
	"\adetails\x18\f \x03(\v24.cloudstack.management.resource.v1.Item.DetailsEntryR\adetails\x1a:\n" +
