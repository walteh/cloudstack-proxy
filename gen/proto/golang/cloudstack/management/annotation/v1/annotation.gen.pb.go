...
const file_cloudstack_management_annotation_v1_annotation_gen_proto_rawDesc = "" +
	...
	"totalCount:\x05\xbaH\x02\b\x00\"_\n" +
	...
	"\x06result\x18\x01 \x01(\v2+.cloudstack.management.annotation.v1.ResultR\x06result\"\x97\x01\n" +
	...
	"\n" +
	"job_status\x18\x05 \x01(\tR\tjobStatus2\x9a\x05\n" +
	"\x11AnnotationService\x12\x8f\x01\n" +
	"\rAddAnnotation\x129.cloudstack.management.annotation.v1.AddAnnotationRequest\x1a:.cloudstack.management.annotation.v1.AddAnnotationResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x95\x01\n" +
	"\x0fListAnnotations\x12;.cloudstack.management.annotation.v1.ListAnnotationsRequest\x1a<.cloudstack.management.annotation.v1.ListAnnotationsResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x98\x01\n" +
	"\x10RemoveAnnotation\x12<.cloudstack.management.annotation.v1.RemoveAnnotationRequest\x1a=.cloudstack.management.annotation.v1.RemoveAnnotationResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\xb6\x01\n" +
	"\x1aUpdateAnnotationVisibility\x12F.cloudstack.management.annotation.v1.UpdateAnnotationVisibilityRequest\x1aG.cloudstack.management.annotation.v1.UpdateAnnotationVisibilityResponse\"\a\xc2>\x04\xc2>\x01\x02\x1a\a\xc2>\x04\xc2>\x01\x02B\xd2\x02\n" +
...
var file_cloudstack_management_annotation_v1_annotation_gen_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_cloudstack_management_annotation_v1_annotation_gen_proto_goTypes = []any{
	...
	(*ListAnnotationsRequest)(nil),             // 2: cloudstack.management.annotation.v1.ListAnnotationsRequest
	(*ListAnnotationsResponse)(nil),            // 3: cloudstack.management.annotation.v1.ListAnnotationsResponse
	(*RemoveAnnotationRequest)(nil),            // 4: cloudstack.management.annotation.v1.RemoveAnnotationRequest
	(*RemoveAnnotationResponse)(nil),           // 5: cloudstack.management.annotation.v1.RemoveAnnotationResponse
	...
	(*Result)(nil),                             // 10: cloudstack.management.annotation.v1.Result
}
var file_cloudstack_management_annotation_v1_annotation_gen_proto_depIdxs = []int32{
	10, // 0: cloudstack.management.annotation.v1.AddAnnotationResponse.result:type_name -> cloudstack.management.annotation.v1.Result
	8,  // 1: cloudstack.management.annotation.v1.ListAnnotationsResponse.items:type_name -> cloudstack.management.annotation.v1.Annotation
	10, // 2: cloudstack.management.annotation.v1.RemoveAnnotationResponse.result:type_name -> cloudstack.management.annotation.v1.Result
	10, // 3: cloudstack.management.annotation.v1.UpdateAnnotationVisibilityResponse.result:type_name -> cloudstack.management.annotation.v1.Result
	0,  // 4: cloudstack.management.annotation.v1.AnnotationService.AddAnnotation:input_type -> cloudstack.management.annotation.v1.AddAnnotationRequest
	2,  // 5: cloudstack.management.annotation.v1.AnnotationService.ListAnnotations:input_type -> cloudstack.management.annotation.v1.ListAnnotationsRequest
	4,  // 6: cloudstack.management.annotation.v1.AnnotationService.RemoveAnnotation:input_type -> cloudstack.management.annotation.v1.RemoveAnnotationRequest
	6,  // 7: cloudstack.management.annotation.v1.AnnotationService.UpdateAnnotationVisibility:input_type -> cloudstack.management.annotation.v1.UpdateAnnotationVisibilityRequest
	1,  // 8: cloudstack.management.annotation.v1.AnnotationService.AddAnnotation:output_type -> cloudstack.management.annotation.v1.AddAnnotationResponse
	3,  // 9: cloudstack.management.annotation.v1.AnnotationService.ListAnnotations:output_type -> cloudstack.management.annotation.v1.ListAnnotationsResponse
	5,  // 10: cloudstack.management.annotation.v1.AnnotationService.RemoveAnnotation:output_type -> cloudstack.management.annotation.v1.RemoveAnnotationResponse
	7,  // 11: cloudstack.management.annotation.v1.AnnotationService.UpdateAnnotationVisibility:output_type -> cloudstack.management.annotation.v1.UpdateAnnotationVisibilityResponse
