...
func (x *Result) Reset() {
	*x = Result{}
	mi := &file_cloudstack_management_acl_v1_acl_gen_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Result) Descriptor() ([]byte, []int) {
	return file_cloudstack_management_acl_v1_acl_gen_proto_rawDescGZIP(), []int{26}
}
...
const file_cloudstack_management_acl_v1_acl_gen_proto_rawDesc = "" +
	...
	"\x06result\x18\x01 \x01(\v2$.cloudstack.management.acl.v1.ResultR\x06result\"\xfe\x01\n" +
	...
	"\adetails\x18\f \x03(\v2/.cloudstack.management.acl.v1.Item.DetailsEntryR\adetails\x1a:\n" +
