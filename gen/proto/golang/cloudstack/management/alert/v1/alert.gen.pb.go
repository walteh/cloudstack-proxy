...
func (x *GenerateAlertRequest) Reset() {
	*x = GenerateAlertRequest{}
	mi := &file_cloudstack_management_alert_v1_alert_gen_proto_msgTypes[0]
...
func (*GenerateAlertRequest) Descriptor() ([]byte, []int) {
	return file_cloudstack_management_alert_v1_alert_gen_proto_rawDescGZIP(), []int{0}
}
...
func (x *GenerateAlertResponse) Reset() {
	*x = GenerateAlertResponse{}
	mi := &file_cloudstack_management_alert_v1_alert_gen_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateAlertResponse) Descriptor() ([]byte, []int) {
	return file_cloudstack_management_alert_v1_alert_gen_proto_rawDescGZIP(), []int{1}
}
...
func (x *Success) Reset() {
	*x = Success{}
	mi := &file_cloudstack_management_alert_v1_alert_gen_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Success) Descriptor() ([]byte, []int) {
	return file_cloudstack_management_alert_v1_alert_gen_proto_rawDescGZIP(), []int{2}
}
...
func (x *Item) Reset() {
	*x = Item{}
	mi := &file_cloudstack_management_alert_v1_alert_gen_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Item) Descriptor() ([]byte, []int) {
	return file_cloudstack_management_alert_v1_alert_gen_proto_rawDescGZIP(), []int{3}
}
...
func (x *Result) Reset() {
	*x = Result{}
	mi := &file_cloudstack_management_alert_v1_alert_gen_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Result) Descriptor() ([]byte, []int) {
	return file_cloudstack_management_alert_v1_alert_gen_proto_rawDescGZIP(), []int{4}
}
...
const file_cloudstack_management_alert_v1_alert_gen_proto_rawDesc = "" +
	...
	"\xc8\x01\x01r\x05\x10\x01\x18\x80\bR\vdescription\x12\x17\n" +
	"\azone_id\x18\x04 \x01(\x03R\x06zoneId\x12\x15\n" +
	"\x06pod_id\x18\x05 \x01(\x03R\x05podId\x12$\n" +
	...
	"\x15GenerateAlertResponse\x12>\n" +
	"\x06result\x18\x01 \x01(\v2&.cloudstack.management.alert.v1.ResultR\x06result\"F\n" +
	"\aSuccess\x12\x18\n" +
	...
	"\adetails\x18\f \x03(\v21.cloudstack.management.alert.v1.Item.DetailsEntryR\adetails\x1a:\n" +
	...
	"\n" +
	"job_status\x18\x05 \x01(\tR\tjobStatus2\x96\x01\n" +
	"\fAlertService\x12~\n" +
	"\rGenerateAlert\x124.cloudstack.management.alert.v1.GenerateAlertRequest\x1a5.cloudstack.management.alert.v1.GenerateAlertResponse\"\x00\x1a\x06\xc2>\x03\xc0>\x02B\xaa\x02\n" +
	"\"com.cloudstack.management.alert.v1B\rAlertGenProtoP\x01ZZgithub.com/walteh/cloudstack-proxy/gen/proto/golang/cloudstack/management/alert/v1;alertv1\xa2\x02\x03CMA\xaa\x02\x1eCloudstack.Management.Alert.V1\xca\x02\x1eCloudstack\\Management\\Alert\\V1\xe2\x02*Cloudstack\\Management\\Alert\\V1\\GPBMetadata\xea\x02!Cloudstack::Management::Alert::V1b\beditionsp\xe8\a"

var (
	file_cloudstack_management_alert_v1_alert_gen_proto_rawDescOnce sync.Once
	file_cloudstack_management_alert_v1_alert_gen_proto_rawDescData []byte
)

func file_cloudstack_management_alert_v1_alert_gen_proto_rawDescGZIP() []byte {
	file_cloudstack_management_alert_v1_alert_gen_proto_rawDescOnce.Do(func() {
		file_cloudstack_management_alert_v1_alert_gen_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cloudstack_management_alert_v1_alert_gen_proto_rawDesc), len(file_cloudstack_management_alert_v1_alert_gen_proto_rawDesc)))
	})
	return file_cloudstack_management_alert_v1_alert_gen_proto_rawDescData
}

var file_cloudstack_management_alert_v1_alert_gen_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_cloudstack_management_alert_v1_alert_gen_proto_goTypes = []any{
	(*GenerateAlertRequest)(nil),  // 0: cloudstack.management.alert.v1.GenerateAlertRequest
	(*GenerateAlertResponse)(nil), // 1: cloudstack.management.alert.v1.GenerateAlertResponse
	(*Success)(nil),               // 2: cloudstack.management.alert.v1.Success
	(*Item)(nil),                  // 3: cloudstack.management.alert.v1.Item
	(*Result)(nil),                // 4: cloudstack.management.alert.v1.Result
	nil,                           // 5: cloudstack.management.alert.v1.Item.DetailsEntry
}
var file_cloudstack_management_alert_v1_alert_gen_proto_depIdxs = []int32{
	4, // 0: cloudstack.management.alert.v1.GenerateAlertResponse.result:type_name -> cloudstack.management.alert.v1.Result
	5, // 1: cloudstack.management.alert.v1.Item.details:type_name -> cloudstack.management.alert.v1.Item.DetailsEntry
	0, // 2: cloudstack.management.alert.v1.AlertService.GenerateAlert:input_type -> cloudstack.management.alert.v1.GenerateAlertRequest
	1, // 3: cloudstack.management.alert.v1.AlertService.GenerateAlert:output_type -> cloudstack.management.alert.v1.GenerateAlertResponse
...
func init() { file_cloudstack_management_alert_v1_alert_gen_proto_init() }
func file_cloudstack_management_alert_v1_alert_gen_proto_init() {
	if File_cloudstack_management_alert_v1_alert_gen_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cloudstack_management_alert_v1_alert_gen_proto_rawDesc), len(file_cloudstack_management_alert_v1_alert_gen_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_cloudstack_management_alert_v1_alert_gen_proto_goTypes,
		DependencyIndexes: file_cloudstack_management_alert_v1_alert_gen_proto_depIdxs,
		MessageInfos:      file_cloudstack_management_alert_v1_alert_gen_proto_msgTypes,
	}.Build()
	File_cloudstack_management_alert_v1_alert_gen_proto = out.File
	file_cloudstack_management_alert_v1_alert_gen_proto_goTypes = nil
	file_cloudstack_management_alert_v1_alert_gen_proto_depIdxs = nil
}
