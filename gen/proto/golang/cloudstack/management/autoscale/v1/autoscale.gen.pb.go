...
const file_cloudstack_management_autoscale_v1_autoscale_gen_proto_rawDesc = "" +
	...
	"totalCount:\x05\xbaH\x02\b\x00\"\xfa\x03\n" +
	...
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount:\x05\xbaH\x02\b\x00\"\xaf\t\n" +
	...
	"\x06result\x18\x01 \x01(\v2*.cloudstack.management.autoscale.v1.ResultR\x06result\"\xb3\x02\n" +
	...
	"\x06result\x18\x01 \x01(\v2*.cloudstack.management.autoscale.v1.ResultR\x06result\"\x84\x05\n" +
	...
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount:\x05\xbaH\x02\b\x00\"\x9d\x02\n" +
	...
	"\x06result\x18\x01 \x01(\v2*.cloudstack.management.autoscale.v1.ResultR\x06result\"\x98\x01\n" +
	"\tCondition\x12\x18\n" +
	...
	"\n" +
	"job_status\x18\x05 \x01(\tR\tjobStatus2\xec\x19\n" +
	"\x10AutoscaleService\x12\x9e\x01\n" +
	"\x15CreateAutoScalePolicy\x12@.cloudstack.management.autoscale.v1.CreateAutoScalePolicyRequest\x1aA.cloudstack.management.autoscale.v1.CreateAutoScalePolicyResponse\"\x00\x12\x89\x01\n" +
	...
	"\x0fCreateCondition\x12:.cloudstack.management.autoscale.v1.CreateConditionRequest\x1a;.cloudstack.management.autoscale.v1.CreateConditionResponse\"\x00\x12\x86\x01\n" +
	"\rDeleteCounter\x128.cloudstack.management.autoscale.v1.DeleteCounterRequest\x1a9.cloudstack.management.autoscale.v1.DeleteCounterResponse\"\x00\x12\x83\x01\n" +
	"\fListCounters\x127.cloudstack.management.autoscale.v1.ListCountersRequest\x1a8.cloudstack.management.autoscale.v1.ListCountersResponse\"\x00\x12\xa7\x01\n" +
	"\x18DeleteAutoScaleVmProfile\x12C.cloudstack.management.autoscale.v1.DeleteAutoScaleVmProfileRequest\x1aD.cloudstack.management.autoscale.v1.DeleteAutoScaleVmProfileResponse\"\x00\x12\x9e\x01\n" +
	"\x15ListAutoScalePolicies\x12@.cloudstack.management.autoscale.v1.ListAutoScalePoliciesRequest\x1aA.cloudstack.management.autoscale.v1.ListAutoScalePoliciesResponse\"\x00\x12\xa7\x01\n" +
	"\x18CreateAutoScaleVmProfile\x12C.cloudstack.management.autoscale.v1.CreateAutoScaleVmProfileRequest\x1aD.cloudstack.management.autoscale.v1.CreateAutoScaleVmProfileResponse\"\x00\x12\x8c\x01\n" +
	"\x0fDeleteCondition\x12:.cloudstack.management.autoscale.v1.DeleteConditionRequest\x1a;.cloudstack.management.autoscale.v1.DeleteConditionResponse\"\x00\x12\xa1\x01\n" +
	"\x16DeleteAutoScaleVmGroup\x12A.cloudstack.management.autoscale.v1.DeleteAutoScaleVmGroupRequest\x1aB.cloudstack.management.autoscale.v1.DeleteAutoScaleVmGroupResponse\"\x00\x12\xa4\x01\n" +
	"\x17DisableAutoScaleVmGroup\x12B.cloudstack.management.autoscale.v1.DisableAutoScaleVmGroupRequest\x1aC.cloudstack.management.autoscale.v1.DisableAutoScaleVmGroupResponse\"\x00\x12\xa7\x01\n" +
	...
	"\x16EnableAutoScaleVmGroup\x12A.cloudstack.management.autoscale.v1.EnableAutoScaleVmGroupRequest\x1aB.cloudstack.management.autoscale.v1.EnableAutoScaleVmGroupResponse\"\x00\x12\xa1\x01\n" +
	"\x16UpdateAutoScaleVmGroup\x12A.cloudstack.management.autoscale.v1.UpdateAutoScaleVmGroupRequest\x1aB.cloudstack.management.autoscale.v1.UpdateAutoScaleVmGroupResponse\"\x00\x12\x9e\x01\n" +
	"\x15UpdateAutoScalePolicy\x12@.cloudstack.management.autoscale.v1.UpdateAutoScalePolicyRequest\x1aA.cloudstack.management.autoscale.v1.UpdateAutoScalePolicyResponse\"\x00\x12\xa1\x01\n" +
	...
	"\x15DeleteAutoScalePolicy\x12@.cloudstack.management.autoscale.v1.DeleteAutoScalePolicyRequest\x1aA.cloudstack.management.autoscale.v1.DeleteAutoScalePolicyResponse\"\x00\x12\x9e\x01\n" +
	"\x15ListAutoScaleVmGroups\x12@.cloudstack.management.autoscale.v1.ListAutoScaleVmGroupsRequest\x1aA.cloudstack.management.autoscale.v1.ListAutoScaleVmGroupsResponse\"\x00\x12\x86\x01\n" +
	"\rCreateCounter\x128.cloudstack.management.autoscale.v1.CreateCounterRequest\x1a9.cloudstack.management.autoscale.v1.CreateCounterResponse\"\x00\x12\xa4\x01\n" +
	"\x17ListAutoScaleVmProfiles\x12B.cloudstack.management.autoscale.v1.ListAutoScaleVmProfilesRequest\x1aC.cloudstack.management.autoscale.v1.ListAutoScaleVmProfilesResponse\"\x00\x12\x8c\x01\n" +
	"\x0fUpdateCondition\x12:.cloudstack.management.autoscale.v1.UpdateConditionRequest\x1a;.cloudstack.management.autoscale.v1.UpdateConditionResponse\"\x00\x1a\x06\xc2>\x03\xc0>\x02B\xca\x02\n" +
...
var file_cloudstack_management_autoscale_v1_autoscale_gen_proto_goTypes = []any{
	(*CreateAutoScalePolicyRequest)(nil),     // 0: cloudstack.management.autoscale.v1.CreateAutoScalePolicyRequest
	(*CreateAutoScalePolicyResponse)(nil),    // 1: cloudstack.management.autoscale.v1.CreateAutoScalePolicyResponse
	(*ListConditionsRequest)(nil),            // 2: cloudstack.management.autoscale.v1.ListConditionsRequest
	(*ListConditionsResponse)(nil),           // 3: cloudstack.management.autoscale.v1.ListConditionsResponse
	(*CreateConditionRequest)(nil),           // 4: cloudstack.management.autoscale.v1.CreateConditionRequest
	(*CreateConditionResponse)(nil),          // 5: cloudstack.management.autoscale.v1.CreateConditionResponse
	(*DeleteCounterRequest)(nil),             // 6: cloudstack.management.autoscale.v1.DeleteCounterRequest
	(*DeleteCounterResponse)(nil),            // 7: cloudstack.management.autoscale.v1.DeleteCounterResponse
	(*ListCountersRequest)(nil),              // 8: cloudstack.management.autoscale.v1.ListCountersRequest
	(*ListCountersResponse)(nil),             // 9: cloudstack.management.autoscale.v1.ListCountersResponse
	(*DeleteAutoScaleVmProfileRequest)(nil),  // 10: cloudstack.management.autoscale.v1.DeleteAutoScaleVmProfileRequest
	(*DeleteAutoScaleVmProfileResponse)(nil), // 11: cloudstack.management.autoscale.v1.DeleteAutoScaleVmProfileResponse
	(*ListAutoScalePoliciesRequest)(nil),     // 12: cloudstack.management.autoscale.v1.ListAutoScalePoliciesRequest
	(*ListAutoScalePoliciesResponse)(nil),    // 13: cloudstack.management.autoscale.v1.ListAutoScalePoliciesResponse
	(*CreateAutoScaleVmProfileRequest)(nil),  // 14: cloudstack.management.autoscale.v1.CreateAutoScaleVmProfileRequest
	(*CreateAutoScaleVmProfileResponse)(nil), // 15: cloudstack.management.autoscale.v1.CreateAutoScaleVmProfileResponse
	(*DeleteConditionRequest)(nil),           // 16: cloudstack.management.autoscale.v1.DeleteConditionRequest
	(*DeleteConditionResponse)(nil),          // 17: cloudstack.management.autoscale.v1.DeleteConditionResponse
	(*DeleteAutoScaleVmGroupRequest)(nil),    // 18: cloudstack.management.autoscale.v1.DeleteAutoScaleVmGroupRequest
	(*DeleteAutoScaleVmGroupResponse)(nil),   // 19: cloudstack.management.autoscale.v1.DeleteAutoScaleVmGroupResponse
	(*DisableAutoScaleVmGroupRequest)(nil),   // 20: cloudstack.management.autoscale.v1.DisableAutoScaleVmGroupRequest
	(*DisableAutoScaleVmGroupResponse)(nil),  // 21: cloudstack.management.autoscale.v1.DisableAutoScaleVmGroupResponse
	(*UpdateAutoScaleVmProfileRequest)(nil),  // 22: cloudstack.management.autoscale.v1.UpdateAutoScaleVmProfileRequest
	(*UpdateAutoScaleVmProfileResponse)(nil), // 23: cloudstack.management.autoscale.v1.UpdateAutoScaleVmProfileResponse
	(*EnableAutoScaleVmGroupRequest)(nil),    // 24: cloudstack.management.autoscale.v1.EnableAutoScaleVmGroupRequest
	(*EnableAutoScaleVmGroupResponse)(nil),   // 25: cloudstack.management.autoscale.v1.EnableAutoScaleVmGroupResponse
	(*UpdateAutoScaleVmGroupRequest)(nil),    // 26: cloudstack.management.autoscale.v1.UpdateAutoScaleVmGroupRequest
	(*UpdateAutoScaleVmGroupResponse)(nil),   // 27: cloudstack.management.autoscale.v1.UpdateAutoScaleVmGroupResponse
	(*UpdateAutoScalePolicyRequest)(nil),     // 28: cloudstack.management.autoscale.v1.UpdateAutoScalePolicyRequest
	(*UpdateAutoScalePolicyResponse)(nil),    // 29: cloudstack.management.autoscale.v1.UpdateAutoScalePolicyResponse
	(*CreateAutoScaleVmGroupRequest)(nil),    // 30: cloudstack.management.autoscale.v1.CreateAutoScaleVmGroupRequest
	(*CreateAutoScaleVmGroupResponse)(nil),   // 31: cloudstack.management.autoscale.v1.CreateAutoScaleVmGroupResponse
	(*DeleteAutoScalePolicyRequest)(nil),     // 32: cloudstack.management.autoscale.v1.DeleteAutoScalePolicyRequest
	(*DeleteAutoScalePolicyResponse)(nil),    // 33: cloudstack.management.autoscale.v1.DeleteAutoScalePolicyResponse
	(*ListAutoScaleVmGroupsRequest)(nil),     // 34: cloudstack.management.autoscale.v1.ListAutoScaleVmGroupsRequest
	(*ListAutoScaleVmGroupsResponse)(nil),    // 35: cloudstack.management.autoscale.v1.ListAutoScaleVmGroupsResponse
	(*CreateCounterRequest)(nil),             // 36: cloudstack.management.autoscale.v1.CreateCounterRequest
	(*CreateCounterResponse)(nil),            // 37: cloudstack.management.autoscale.v1.CreateCounterResponse
	(*ListAutoScaleVmProfilesRequest)(nil),   // 38: cloudstack.management.autoscale.v1.ListAutoScaleVmProfilesRequest
	(*ListAutoScaleVmProfilesResponse)(nil),  // 39: cloudstack.management.autoscale.v1.ListAutoScaleVmProfilesResponse
	(*UpdateConditionRequest)(nil),           // 40: cloudstack.management.autoscale.v1.UpdateConditionRequest
	(*UpdateConditionResponse)(nil),          // 41: cloudstack.management.autoscale.v1.UpdateConditionResponse
	(*Condition)(nil),                        // 42: cloudstack.management.autoscale.v1.Condition
	(*Counter)(nil),                          // 43: cloudstack.management.autoscale.v1.Counter
	(*AutoScalePolicy)(nil),                  // 44: cloudstack.management.autoscale.v1.AutoScalePolicy
	(*AutoScaleVmGroup)(nil),                 // 45: cloudstack.management.autoscale.v1.AutoScaleVmGroup
	(*AutoScaleVmProfile)(nil),               // 46: cloudstack.management.autoscale.v1.AutoScaleVmProfile
	(*Success)(nil),                          // 47: cloudstack.management.autoscale.v1.Success
	(*Item)(nil),                             // 48: cloudstack.management.autoscale.v1.Item
	...
	nil,                                      // 56: cloudstack.management.autoscale.v1.Item.DetailsEntry
}
var file_cloudstack_management_autoscale_v1_autoscale_gen_proto_depIdxs = []int32{
	...
	42, // 1: cloudstack.management.autoscale.v1.ListConditionsResponse.items:type_name -> cloudstack.management.autoscale.v1.Condition
	49, // 2: cloudstack.management.autoscale.v1.CreateConditionResponse.result:type_name -> cloudstack.management.autoscale.v1.Result
	49, // 3: cloudstack.management.autoscale.v1.DeleteCounterResponse.result:type_name -> cloudstack.management.autoscale.v1.Result
	43, // 4: cloudstack.management.autoscale.v1.ListCountersResponse.items:type_name -> cloudstack.management.autoscale.v1.Counter
	49, // 5: cloudstack.management.autoscale.v1.DeleteAutoScaleVmProfileResponse.result:type_name -> cloudstack.management.autoscale.v1.Result
	44, // 6: cloudstack.management.autoscale.v1.ListAutoScalePoliciesResponse.items:type_name -> cloudstack.management.autoscale.v1.AutoScalePolicy
	50, // 7: cloudstack.management.autoscale.v1.CreateAutoScaleVmProfileRequest.other_deploy_params:type_name -> cloudstack.management.autoscale.v1.CreateAutoScaleVmProfileRequest.OtherDeployParamsEntry
	51, // 8: cloudstack.management.autoscale.v1.CreateAutoScaleVmProfileRequest.counter_param_list:type_name -> cloudstack.management.autoscale.v1.CreateAutoScaleVmProfileRequest.CounterParamListEntry
	52, // 9: cloudstack.management.autoscale.v1.CreateAutoScaleVmProfileRequest.user_data_details:type_name -> cloudstack.management.autoscale.v1.CreateAutoScaleVmProfileRequest.UserDataDetailsEntry
	49, // 10: cloudstack.management.autoscale.v1.CreateAutoScaleVmProfileResponse.result:type_name -> cloudstack.management.autoscale.v1.Result
	...
	49, // 12: cloudstack.management.autoscale.v1.DeleteAutoScaleVmGroupResponse.result:type_name -> cloudstack.management.autoscale.v1.Result
	...
	53, // 14: cloudstack.management.autoscale.v1.UpdateAutoScaleVmProfileRequest.counter_param_list:type_name -> cloudstack.management.autoscale.v1.UpdateAutoScaleVmProfileRequest.CounterParamListEntry
	54, // 15: cloudstack.management.autoscale.v1.UpdateAutoScaleVmProfileRequest.other_deploy_params:type_name -> cloudstack.management.autoscale.v1.UpdateAutoScaleVmProfileRequest.OtherDeployParamsEntry
	55, // 16: cloudstack.management.autoscale.v1.UpdateAutoScaleVmProfileRequest.user_data_details:type_name -> cloudstack.management.autoscale.v1.UpdateAutoScaleVmProfileRequest.UserDataDetailsEntry
	49, // 17: cloudstack.management.autoscale.v1.UpdateAutoScaleVmProfileResponse.result:type_name -> cloudstack.management.autoscale.v1.Result
	49, // 18: cloudstack.management.autoscale.v1.EnableAutoScaleVmGroupResponse.result:type_name -> cloudstack.management.autoscale.v1.Result
	49, // 19: cloudstack.management.autoscale.v1.UpdateAutoScaleVmGroupResponse.result:type_name -> cloudstack.management.autoscale.v1.Result
	...
	49, // 21: cloudstack.management.autoscale.v1.CreateAutoScaleVmGroupResponse.result:type_name -> cloudstack.management.autoscale.v1.Result
	49, // 22: cloudstack.management.autoscale.v1.DeleteAutoScalePolicyResponse.result:type_name -> cloudstack.management.autoscale.v1.Result
	45, // 23: cloudstack.management.autoscale.v1.ListAutoScaleVmGroupsResponse.items:type_name -> cloudstack.management.autoscale.v1.AutoScaleVmGroup
	49, // 24: cloudstack.management.autoscale.v1.CreateCounterResponse.result:type_name -> cloudstack.management.autoscale.v1.Result
	46, // 25: cloudstack.management.autoscale.v1.ListAutoScaleVmProfilesResponse.items:type_name -> cloudstack.management.autoscale.v1.AutoScaleVmProfile
	...
	56, // 27: cloudstack.management.autoscale.v1.Item.details:type_name -> cloudstack.management.autoscale.v1.Item.DetailsEntry
	0,  // 28: cloudstack.management.autoscale.v1.AutoscaleService.CreateAutoScalePolicy:input_type -> cloudstack.management.autoscale.v1.CreateAutoScalePolicyRequest
	2,  // 29: cloudstack.management.autoscale.v1.AutoscaleService.ListConditions:input_type -> cloudstack.management.autoscale.v1.ListConditionsRequest
	4,  // 30: cloudstack.management.autoscale.v1.AutoscaleService.CreateCondition:input_type -> cloudstack.management.autoscale.v1.CreateConditionRequest
	6,  // 31: cloudstack.management.autoscale.v1.AutoscaleService.DeleteCounter:input_type -> cloudstack.management.autoscale.v1.DeleteCounterRequest
	8,  // 32: cloudstack.management.autoscale.v1.AutoscaleService.ListCounters:input_type -> cloudstack.management.autoscale.v1.ListCountersRequest
	10, // 33: cloudstack.management.autoscale.v1.AutoscaleService.DeleteAutoScaleVmProfile:input_type -> cloudstack.management.autoscale.v1.DeleteAutoScaleVmProfileRequest
	12, // 34: cloudstack.management.autoscale.v1.AutoscaleService.ListAutoScalePolicies:input_type -> cloudstack.management.autoscale.v1.ListAutoScalePoliciesRequest
	14, // 35: cloudstack.management.autoscale.v1.AutoscaleService.CreateAutoScaleVmProfile:input_type -> cloudstack.management.autoscale.v1.CreateAutoScaleVmProfileRequest
	16, // 36: cloudstack.management.autoscale.v1.AutoscaleService.DeleteCondition:input_type -> cloudstack.management.autoscale.v1.DeleteConditionRequest
	18, // 37: cloudstack.management.autoscale.v1.AutoscaleService.DeleteAutoScaleVmGroup:input_type -> cloudstack.management.autoscale.v1.DeleteAutoScaleVmGroupRequest
	20, // 38: cloudstack.management.autoscale.v1.AutoscaleService.DisableAutoScaleVmGroup:input_type -> cloudstack.management.autoscale.v1.DisableAutoScaleVmGroupRequest
	22, // 39: cloudstack.management.autoscale.v1.AutoscaleService.UpdateAutoScaleVmProfile:input_type -> cloudstack.management.autoscale.v1.UpdateAutoScaleVmProfileRequest
	24, // 40: cloudstack.management.autoscale.v1.AutoscaleService.EnableAutoScaleVmGroup:input_type -> cloudstack.management.autoscale.v1.EnableAutoScaleVmGroupRequest
	26, // 41: cloudstack.management.autoscale.v1.AutoscaleService.UpdateAutoScaleVmGroup:input_type -> cloudstack.management.autoscale.v1.UpdateAutoScaleVmGroupRequest
	28, // 42: cloudstack.management.autoscale.v1.AutoscaleService.UpdateAutoScalePolicy:input_type -> cloudstack.management.autoscale.v1.UpdateAutoScalePolicyRequest
	30, // 43: cloudstack.management.autoscale.v1.AutoscaleService.CreateAutoScaleVmGroup:input_type -> cloudstack.management.autoscale.v1.CreateAutoScaleVmGroupRequest
	32, // 44: cloudstack.management.autoscale.v1.AutoscaleService.DeleteAutoScalePolicy:input_type -> cloudstack.management.autoscale.v1.DeleteAutoScalePolicyRequest
	34, // 45: cloudstack.management.autoscale.v1.AutoscaleService.ListAutoScaleVmGroups:input_type -> cloudstack.management.autoscale.v1.ListAutoScaleVmGroupsRequest
	36, // 46: cloudstack.management.autoscale.v1.AutoscaleService.CreateCounter:input_type -> cloudstack.management.autoscale.v1.CreateCounterRequest
	38, // 47: cloudstack.management.autoscale.v1.AutoscaleService.ListAutoScaleVmProfiles:input_type -> cloudstack.management.autoscale.v1.ListAutoScaleVmProfilesRequest
	40, // 48: cloudstack.management.autoscale.v1.AutoscaleService.UpdateCondition:input_type -> cloudstack.management.autoscale.v1.UpdateConditionRequest
	1,  // 49: cloudstack.management.autoscale.v1.AutoscaleService.CreateAutoScalePolicy:output_type -> cloudstack.management.autoscale.v1.CreateAutoScalePolicyResponse
	3,  // 50: cloudstack.management.autoscale.v1.AutoscaleService.ListConditions:output_type -> cloudstack.management.autoscale.v1.ListConditionsResponse
	5,  // 51: cloudstack.management.autoscale.v1.AutoscaleService.CreateCondition:output_type -> cloudstack.management.autoscale.v1.CreateConditionResponse
	7,  // 52: cloudstack.management.autoscale.v1.AutoscaleService.DeleteCounter:output_type -> cloudstack.management.autoscale.v1.DeleteCounterResponse
	9,  // 53: cloudstack.management.autoscale.v1.AutoscaleService.ListCounters:output_type -> cloudstack.management.autoscale.v1.ListCountersResponse
	11, // 54: cloudstack.management.autoscale.v1.AutoscaleService.DeleteAutoScaleVmProfile:output_type -> cloudstack.management.autoscale.v1.DeleteAutoScaleVmProfileResponse
	13, // 55: cloudstack.management.autoscale.v1.AutoscaleService.ListAutoScalePolicies:output_type -> cloudstack.management.autoscale.v1.ListAutoScalePoliciesResponse
	15, // 56: cloudstack.management.autoscale.v1.AutoscaleService.CreateAutoScaleVmProfile:output_type -> cloudstack.management.autoscale.v1.CreateAutoScaleVmProfileResponse
	17, // 57: cloudstack.management.autoscale.v1.AutoscaleService.DeleteCondition:output_type -> cloudstack.management.autoscale.v1.DeleteConditionResponse
	19, // 58: cloudstack.management.autoscale.v1.AutoscaleService.DeleteAutoScaleVmGroup:output_type -> cloudstack.management.autoscale.v1.DeleteAutoScaleVmGroupResponse
	21, // 59: cloudstack.management.autoscale.v1.AutoscaleService.DisableAutoScaleVmGroup:output_type -> cloudstack.management.autoscale.v1.DisableAutoScaleVmGroupResponse
	23, // 60: cloudstack.management.autoscale.v1.AutoscaleService.UpdateAutoScaleVmProfile:output_type -> cloudstack.management.autoscale.v1.UpdateAutoScaleVmProfileResponse
	25, // 61: cloudstack.management.autoscale.v1.AutoscaleService.EnableAutoScaleVmGroup:output_type -> cloudstack.management.autoscale.v1.EnableAutoScaleVmGroupResponse
	27, // 62: cloudstack.management.autoscale.v1.AutoscaleService.UpdateAutoScaleVmGroup:output_type -> cloudstack.management.autoscale.v1.UpdateAutoScaleVmGroupResponse
	29, // 63: cloudstack.management.autoscale.v1.AutoscaleService.UpdateAutoScalePolicy:output_type -> cloudstack.management.autoscale.v1.UpdateAutoScalePolicyResponse
	31, // 64: cloudstack.management.autoscale.v1.AutoscaleService.CreateAutoScaleVmGroup:output_type -> cloudstack.management.autoscale.v1.CreateAutoScaleVmGroupResponse
	33, // 65: cloudstack.management.autoscale.v1.AutoscaleService.DeleteAutoScalePolicy:output_type -> cloudstack.management.autoscale.v1.DeleteAutoScalePolicyResponse
	35, // 66: cloudstack.management.autoscale.v1.AutoscaleService.ListAutoScaleVmGroups:output_type -> cloudstack.management.autoscale.v1.ListAutoScaleVmGroupsResponse
	37, // 67: cloudstack.management.autoscale.v1.AutoscaleService.CreateCounter:output_type -> cloudstack.management.autoscale.v1.CreateCounterResponse
	39, // 68: cloudstack.management.autoscale.v1.AutoscaleService.ListAutoScaleVmProfiles:output_type -> cloudstack.management.autoscale.v1.ListAutoScaleVmProfilesResponse
	41, // 69: cloudstack.management.autoscale.v1.AutoscaleService.UpdateCondition:output_type -> cloudstack.management.autoscale.v1.UpdateConditionResponse
