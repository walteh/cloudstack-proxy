...
func (x *Result) Reset() {
	*x = Result{}
	mi := &file_cloudstack_management_vpn_v1_vpn_gen_proto_msgTypes[47]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Result) Descriptor() ([]byte, []int) {
	return file_cloudstack_management_vpn_v1_vpn_gen_proto_rawDescGZIP(), []int{47}
}
...
const file_cloudstack_management_vpn_v1_vpn_gen_proto_rawDesc = "" +
	...
	"\adetails\x18\f \x03(\v2/.cloudstack.management.vpn.v1.Item.DetailsEntryR\adetails\x1a:\n" +
