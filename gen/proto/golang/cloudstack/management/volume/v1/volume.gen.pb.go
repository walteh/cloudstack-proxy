...
func (x *DestroyVolumeCmdByAdminRequest) Reset() {
	*x = DestroyVolumeCmdByAdminRequest{}
	mi := &file_cloudstack_management_volume_v1_volume_gen_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DestroyVolumeCmdByAdminRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DestroyVolumeCmdByAdminRequest) ProtoMessage() {}

func (x *DestroyVolumeCmdByAdminRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cloudstack_management_volume_v1_volume_gen_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *DestroyVolumeCmdByAdminRequest) GetId() int64 {
	if x != nil && x.Id != nil {
		return *x.Id
	}
	return 0
...
func (x *DestroyVolumeCmdByAdminResponse) Reset() {
	*x = DestroyVolumeCmdByAdminResponse{}
	mi := &file_cloudstack_management_volume_v1_volume_gen_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DestroyVolumeCmdByAdminResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DestroyVolumeCmdByAdminResponse) ProtoMessage() {}

func (x *DestroyVolumeCmdByAdminResponse) ProtoReflect() protoreflect.Message {
	mi := &file_cloudstack_management_volume_v1_volume_gen_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *UploadVolumeCmdByAdminRequest) Reset() {
	*x = UploadVolumeCmdByAdminRequest{}
	mi := &file_cloudstack_management_volume_v1_volume_gen_proto_msgTypes[62]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UploadVolumeCmdByAdminRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UploadVolumeCmdByAdminRequest) ProtoMessage() {}

func (x *UploadVolumeCmdByAdminRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cloudstack_management_volume_v1_volume_gen_proto_msgTypes[62]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *UploadVolumeCmdByAdminRequest) GetUrl() string {
	if x != nil && x.Url != nil {
		return *x.Url
	}
	return ""
...
func (x *UploadVolumeCmdByAdminResponse) Reset() {
	*x = UploadVolumeCmdByAdminResponse{}
	mi := &file_cloudstack_management_volume_v1_volume_gen_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UploadVolumeCmdByAdminResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UploadVolumeCmdByAdminResponse) ProtoMessage() {}

func (x *UploadVolumeCmdByAdminResponse) ProtoReflect() protoreflect.Message {
	mi := &file_cloudstack_management_volume_v1_volume_gen_proto_msgTypes[63]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *VolumeForImport) Reset() {
	*x = VolumeForImport{}
	mi := &file_cloudstack_management_volume_v1_volume_gen_proto_msgTypes[66]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VolumeForImport) Descriptor() ([]byte, []int) {
	return file_cloudstack_management_volume_v1_volume_gen_proto_rawDescGZIP(), []int{66}
}
...
func (x *Success) Reset() {
	*x = Success{}
	mi := &file_cloudstack_management_volume_v1_volume_gen_proto_msgTypes[67]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Success) Descriptor() ([]byte, []int) {
	return file_cloudstack_management_volume_v1_volume_gen_proto_rawDescGZIP(), []int{67}
}
...
func (x *Result) Reset() {
	*x = Result{}
	mi := &file_cloudstack_management_volume_v1_volume_gen_proto_msgTypes[68]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Result) Descriptor() ([]byte, []int) {
	return file_cloudstack_management_volume_v1_volume_gen_proto_rawDescGZIP(), []int{68}
}
...
const file_cloudstack_management_volume_v1_volume_gen_proto_rawDesc = "" +
	...
	"\x06result\x18\x01 \x01(\v2'.cloudstack.management.volume.v1.ResultR\x06result\"R\n" +
	"\x13DeleteVolumeRequest\x12\x16\n" +
	"\x02id\x18\x01 \x01(\x03B\x06\xbaH\x03\xc8\x01\x01R\x02id\x12#\n" +
	"\rresponse_type\x18\x02 \x01(\tR\fresponseType\"W\n" +
	"\x14DeleteVolumeResponse\x12?\n" +
	"\x06result\x18\x01 \x01(\v2'.cloudstack.management.volume.v1.ResultR\x06result\"\xee\x01\n" +
	...
	"\x06result\x18\x01 \x01(\v2'.cloudstack.management.volume.v1.ResultR\x06result\"\xd6\x01\n" +
	"\x1eDestroyVolumeCmdByAdminRequest\x12\x16\n" +
	"\x02id\x18\x01 \x01(\x03B\x06\xbaH\x03\xc8\x01\x01R\x02id\x12\x1f\n" +
	"\aexpunge\x18\x02 \x01(\bB\x05\xaa\x01\x02\b\x01R\aexpunge\x12$\n" +
	"\x0estart_event_id\x18\x03 \x01(\x03R\fstartEventId\x120\n" +
	"\x0finjected_job_id\x18\x04 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\rinjectedJobId\x12#\n" +
	"\rresponse_type\x18\x05 \x01(\tR\fresponseType\"b\n" +
	"\x1fDestroyVolumeCmdByAdminResponse\x12?\n" +
	...
	"totalCount:\x05\xbaH\x02\b\x00\"\xa7\t\n" +
	...
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount:\x05\xbaH\x02\b\x00\"\x99\t\n" +
	...
	"\x05items\x18\x01 \x03(\v2'.cloudstack.management.volume.v1.VolumeR\x05items\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount:\x05\xbaH\x02\b\x00\"\xc8\x01\n" +
	...
	"\x06result\x18\x01 \x01(\v2'.cloudstack.management.volume.v1.ResultR\x06result\"\x80\x04\n" +
	"\x1dUploadVolumeCmdByAdminRequest\x12\x1e\n" +
	"\x06format\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x06format\x12.\n" +
	"\vvolume_name\x18\x02 \x01(\tB\r\xbaH\n" +
	"\xc8\x01\x01r\x05\x10\x01\x18\xff\x01R\n" +
	"volumeName\x12\x18\n" +
	"\x03url\x18\x03 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x03url\x12\x1f\n" +
	"\azone_id\x18\x04 \x01(\x03B\x06\xbaH\x03\xc8\x01\x01R\x06zoneId\x12\x1b\n" +
	"\tdomain_id\x18\x05 \x01(\x03R\bdomainId\x12!\n" +
	"\faccount_name\x18\x06 \x01(\tR\vaccountName\x12\x1a\n" +
	"\bchecksum\x18\a \x01(\tR\bchecksum\x122\n" +
	"\x10image_store_uuid\x18\b \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x0eimageStoreUuid\x12\x1d\n" +
	"\n" +
	"project_id\x18\t \x01(\x03R\tprojectId\x12(\n" +
	"\x10disk_offering_id\x18\n" +
	" \x01(\x03R\x0ediskOfferingId\x12$\n" +
	"\x0estart_event_id\x18\v \x01(\x03R\fstartEventId\x120\n" +
	"\x0finjected_job_id\x18\f \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\rinjectedJobId\x12#\n" +
	"\rresponse_type\x18\r \x01(\tR\fresponseType\"a\n" +
	"\x1eUploadVolumeCmdByAdminResponse\x12?\n" +
	"\x06result\x18\x01 \x01(\v2'.cloudstack.management.volume.v1.ResultR\x06result\"\x9a\x01\n" +
	...
	"\n" +
	"job_status\x18\x05 \x01(\tR\tjobStatus2\xf4%\n" +
	"\rVolumeService\x12\x93\x01\n" +
	"\x11AddResourceDetail\x129.cloudstack.management.volume.v1.AddResourceDetailRequest\x1a:.cloudstack.management.volume.v1.AddResourceDetailResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x84\x01\n" +
	"\fAssignVolume\x124.cloudstack.management.volume.v1.AssignVolumeRequest\x1a5.cloudstack.management.volume.v1.AssignVolumeResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x85\x01\n" +
	"\fAttachVolume\x124.cloudstack.management.volume.v1.AttachVolumeRequest\x1a5.cloudstack.management.volume.v1.AttachVolumeResponse\"\b\xc2>\x05\xc2>\x02\x01\x02\x12\xa2\x01\n" +
	"\x16AttachVolumeCmdByAdmin\x12>.cloudstack.management.volume.v1.AttachVolumeCmdByAdminRequest\x1a?.cloudstack.management.volume.v1.AttachVolumeCmdByAdminResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\xa5\x01\n" +
	"\x17ChangeOfferingForVolume\x12?.cloudstack.management.volume.v1.ChangeOfferingForVolumeRequest\x1a@.cloudstack.management.volume.v1.ChangeOfferingForVolumeResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x9c\x01\n" +
	"\x14CheckAndRepairVolume\x12<.cloudstack.management.volume.v1.CheckAndRepairVolumeRequest\x1a=.cloudstack.management.volume.v1.CheckAndRepairVolumeResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x85\x01\n" +
	"\fCreateVolume\x124.cloudstack.management.volume.v1.CreateVolumeRequest\x1a5.cloudstack.management.volume.v1.CreateVolumeResponse\"\b\xc2>\x05\xc2>\x02\x01\x02\x12\xa2\x01\n" +
	"\x16CreateVolumeCmdByAdmin\x12>.cloudstack.management.volume.v1.CreateVolumeCmdByAdminRequest\x1a?.cloudstack.management.volume.v1.CreateVolumeCmdByAdminResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x84\x01\n" +
	"\fDeleteVolume\x124.cloudstack.management.volume.v1.DeleteVolumeRequest\x1a5.cloudstack.management.volume.v1.DeleteVolumeResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x88\x01\n" +
	"\rDestroyVolume\x125.cloudstack.management.volume.v1.DestroyVolumeRequest\x1a6.cloudstack.management.volume.v1.DestroyVolumeResponse\"\b\xc2>\x05\xc2>\x02\x01\x02\x12\xa5\x01\n" +
	"\x17DestroyVolumeCmdByAdmin\x12?.cloudstack.management.volume.v1.DestroyVolumeCmdByAdminRequest\x1a@.cloudstack.management.volume.v1.DestroyVolumeCmdByAdminResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x85\x01\n" +
	"\fDetachVolume\x124.cloudstack.management.volume.v1.DetachVolumeRequest\x1a5.cloudstack.management.volume.v1.DetachVolumeResponse\"\b\xc2>\x05\xc2>\x02\x01\x02\x12\xa2\x01\n" +
	"\x16DetachVolumeCmdByAdmin\x12>.cloudstack.management.volume.v1.DetachVolumeCmdByAdminRequest\x1a?.cloudstack.management.volume.v1.DetachVolumeCmdByAdminResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x87\x01\n" +
	"\rExtractVolume\x125.cloudstack.management.volume.v1.ExtractVolumeRequest\x1a6.cloudstack.management.volume.v1.ExtractVolumeResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\xa8\x01\n" +
	"\x18GetUploadParamsForVolume\x12@.cloudstack.management.volume.v1.GetUploadParamsForVolumeRequest\x1aA.cloudstack.management.volume.v1.GetUploadParamsForVolumeResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x84\x01\n" +
	"\fImportVolume\x124.cloudstack.management.volume.v1.ImportVolumeRequest\x1a5.cloudstack.management.volume.v1.ImportVolumeResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x99\x01\n" +
	"\x13ListResourceDetails\x12;.cloudstack.management.volume.v1.ListResourceDetailsRequest\x1a<.cloudstack.management.volume.v1.ListResourceDetailsResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x82\x01\n" +
	"\vListVolumes\x123.cloudstack.management.volume.v1.ListVolumesRequest\x1a4.cloudstack.management.volume.v1.ListVolumesResponse\"\b\xc2>\x05\xc2>\x02\x01\x02\x12\x9f\x01\n" +
	"\x15ListVolumesCmdByAdmin\x12=.cloudstack.management.volume.v1.ListVolumesCmdByAdminRequest\x1a>.cloudstack.management.volume.v1.ListVolumesCmdByAdminResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x9c\x01\n" +
	"\x14ListVolumesForImport\x12<.cloudstack.management.volume.v1.ListVolumesForImportRequest\x1a=.cloudstack.management.volume.v1.ListVolumesForImportResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x88\x01\n" +
	"\rMigrateVolume\x125.cloudstack.management.volume.v1.MigrateVolumeRequest\x1a6.cloudstack.management.volume.v1.MigrateVolumeResponse\"\b\xc2>\x05\xc2>\x02\x01\x02\x12\xa5\x01\n" +
	"\x17MigrateVolumeCmdByAdmin\x12?.cloudstack.management.volume.v1.MigrateVolumeCmdByAdminRequest\x1a@.cloudstack.management.volume.v1.MigrateVolumeCmdByAdminResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x88\x01\n" +
	"\rRecoverVolume\x125.cloudstack.management.volume.v1.RecoverVolumeRequest\x1a6.cloudstack.management.volume.v1.RecoverVolumeResponse\"\b\xc2>\x05\xc2>\x02\x01\x02\x12\xa5\x01\n" +
	"\x17RecoverVolumeCmdByAdmin\x12?.cloudstack.management.volume.v1.RecoverVolumeCmdByAdminRequest\x1a@.cloudstack.management.volume.v1.RecoverVolumeCmdByAdminResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x9c\x01\n" +
	"\x14RemoveResourceDetail\x12<.cloudstack.management.volume.v1.RemoveResourceDetailRequest\x1a=.cloudstack.management.volume.v1.RemoveResourceDetailResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x85\x01\n" +
	"\fResizeVolume\x124.cloudstack.management.volume.v1.ResizeVolumeRequest\x1a5.cloudstack.management.volume.v1.ResizeVolumeResponse\"\b\xc2>\x05\xc2>\x02\x01\x02\x12\xa2\x01\n" +
	"\x16ResizeVolumeCmdByAdmin\x12>.cloudstack.management.volume.v1.ResizeVolumeCmdByAdminRequest\x1a?.cloudstack.management.volume.v1.ResizeVolumeCmdByAdminResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x8a\x01\n" +
	"\x0eUnmanageVolume\x126.cloudstack.management.volume.v1.UnmanageVolumeRequest\x1a7.cloudstack.management.volume.v1.UnmanageVolumeResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x85\x01\n" +
	"\fUpdateVolume\x124.cloudstack.management.volume.v1.UpdateVolumeRequest\x1a5.cloudstack.management.volume.v1.UpdateVolumeResponse\"\b\xc2>\x05\xc2>\x02\x01\x02\x12\xa2\x01\n" +
	"\x16UpdateVolumeCmdByAdmin\x12>.cloudstack.management.volume.v1.UpdateVolumeCmdByAdminRequest\x1a?.cloudstack.management.volume.v1.UpdateVolumeCmdByAdminResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x85\x01\n" +
	"\fUploadVolume\x124.cloudstack.management.volume.v1.UploadVolumeRequest\x1a5.cloudstack.management.volume.v1.UploadVolumeResponse\"\b\xc2>\x05\xc2>\x02\x01\x02\x12\xa2\x01\n" +
	"\x16UploadVolumeCmdByAdmin\x12>.cloudstack.management.volume.v1.UploadVolumeCmdByAdminRequest\x1a?.cloudstack.management.volume.v1.UploadVolumeCmdByAdminResponse\"\a\xc2>\x04\xc2>\x01\x02\x1a\a\xc2>\x04\xc2>\x01\x02B\xb2\x02\n" +
...
var file_cloudstack_management_volume_v1_volume_gen_proto_msgTypes = make([]protoimpl.MessageInfo, 72)
var file_cloudstack_management_volume_v1_volume_gen_proto_goTypes = []any{
	(*AddResourceDetailRequest)(nil),         // 0: cloudstack.management.volume.v1.AddResourceDetailRequest
	(*AddResourceDetailResponse)(nil),        // 1: cloudstack.management.volume.v1.AddResourceDetailResponse
	(*AssignVolumeRequest)(nil),              // 2: cloudstack.management.volume.v1.AssignVolumeRequest
	(*AssignVolumeResponse)(nil),             // 3: cloudstack.management.volume.v1.AssignVolumeResponse
	(*AttachVolumeRequest)(nil),              // 4: cloudstack.management.volume.v1.AttachVolumeRequest
	(*AttachVolumeResponse)(nil),             // 5: cloudstack.management.volume.v1.AttachVolumeResponse
	(*AttachVolumeCmdByAdminRequest)(nil),    // 6: cloudstack.management.volume.v1.AttachVolumeCmdByAdminRequest
	(*AttachVolumeCmdByAdminResponse)(nil),   // 7: cloudstack.management.volume.v1.AttachVolumeCmdByAdminResponse
	(*ChangeOfferingForVolumeRequest)(nil),   // 8: cloudstack.management.volume.v1.ChangeOfferingForVolumeRequest
	(*ChangeOfferingForVolumeResponse)(nil),  // 9: cloudstack.management.volume.v1.ChangeOfferingForVolumeResponse
	(*CheckAndRepairVolumeRequest)(nil),      // 10: cloudstack.management.volume.v1.CheckAndRepairVolumeRequest
	(*CheckAndRepairVolumeResponse)(nil),     // 11: cloudstack.management.volume.v1.CheckAndRepairVolumeResponse
	(*CreateVolumeRequest)(nil),              // 12: cloudstack.management.volume.v1.CreateVolumeRequest
	(*CreateVolumeResponse)(nil),             // 13: cloudstack.management.volume.v1.CreateVolumeResponse
	(*CreateVolumeCmdByAdminRequest)(nil),    // 14: cloudstack.management.volume.v1.CreateVolumeCmdByAdminRequest
	(*CreateVolumeCmdByAdminResponse)(nil),   // 15: cloudstack.management.volume.v1.CreateVolumeCmdByAdminResponse
	(*DeleteVolumeRequest)(nil),              // 16: cloudstack.management.volume.v1.DeleteVolumeRequest
	(*DeleteVolumeResponse)(nil),             // 17: cloudstack.management.volume.v1.DeleteVolumeResponse
	(*DestroyVolumeRequest)(nil),             // 18: cloudstack.management.volume.v1.DestroyVolumeRequest
	(*DestroyVolumeResponse)(nil),            // 19: cloudstack.management.volume.v1.DestroyVolumeResponse
	(*DestroyVolumeCmdByAdminRequest)(nil),   // 20: cloudstack.management.volume.v1.DestroyVolumeCmdByAdminRequest
	(*DestroyVolumeCmdByAdminResponse)(nil),  // 21: cloudstack.management.volume.v1.DestroyVolumeCmdByAdminResponse
	(*DetachVolumeRequest)(nil),              // 22: cloudstack.management.volume.v1.DetachVolumeRequest
	(*DetachVolumeResponse)(nil),             // 23: cloudstack.management.volume.v1.DetachVolumeResponse
	(*DetachVolumeCmdByAdminRequest)(nil),    // 24: cloudstack.management.volume.v1.DetachVolumeCmdByAdminRequest
	(*DetachVolumeCmdByAdminResponse)(nil),   // 25: cloudstack.management.volume.v1.DetachVolumeCmdByAdminResponse
	(*ExtractVolumeRequest)(nil),             // 26: cloudstack.management.volume.v1.ExtractVolumeRequest
	(*ExtractVolumeResponse)(nil),            // 27: cloudstack.management.volume.v1.ExtractVolumeResponse
	(*GetUploadParamsForVolumeRequest)(nil),  // 28: cloudstack.management.volume.v1.GetUploadParamsForVolumeRequest
	(*GetUploadParamsForVolumeResponse)(nil), // 29: cloudstack.management.volume.v1.GetUploadParamsForVolumeResponse
	(*ImportVolumeRequest)(nil),              // 30: cloudstack.management.volume.v1.ImportVolumeRequest
	(*ImportVolumeResponse)(nil),             // 31: cloudstack.management.volume.v1.ImportVolumeResponse
	(*ListResourceDetailsRequest)(nil),       // 32: cloudstack.management.volume.v1.ListResourceDetailsRequest
	(*ListResourceDetailsResponse)(nil),      // 33: cloudstack.management.volume.v1.ListResourceDetailsResponse
	...
	(*ListVolumesCmdByAdminRequest)(nil),     // 36: cloudstack.management.volume.v1.ListVolumesCmdByAdminRequest
	(*ListVolumesCmdByAdminResponse)(nil),    // 37: cloudstack.management.volume.v1.ListVolumesCmdByAdminResponse
	(*ListVolumesForImportRequest)(nil),      // 38: cloudstack.management.volume.v1.ListVolumesForImportRequest
	(*ListVolumesForImportResponse)(nil),     // 39: cloudstack.management.volume.v1.ListVolumesForImportResponse
	...
	(*MigrateVolumeCmdByAdminRequest)(nil),   // 42: cloudstack.management.volume.v1.MigrateVolumeCmdByAdminRequest
	(*MigrateVolumeCmdByAdminResponse)(nil),  // 43: cloudstack.management.volume.v1.MigrateVolumeCmdByAdminResponse
	(*RecoverVolumeRequest)(nil),             // 44: cloudstack.management.volume.v1.RecoverVolumeRequest
	(*RecoverVolumeResponse)(nil),            // 45: cloudstack.management.volume.v1.RecoverVolumeResponse
	(*RecoverVolumeCmdByAdminRequest)(nil),   // 46: cloudstack.management.volume.v1.RecoverVolumeCmdByAdminRequest
	(*RecoverVolumeCmdByAdminResponse)(nil),  // 47: cloudstack.management.volume.v1.RecoverVolumeCmdByAdminResponse
	(*RemoveResourceDetailRequest)(nil),      // 48: cloudstack.management.volume.v1.RemoveResourceDetailRequest
	(*RemoveResourceDetailResponse)(nil),     // 49: cloudstack.management.volume.v1.RemoveResourceDetailResponse
	(*ResizeVolumeRequest)(nil),              // 50: cloudstack.management.volume.v1.ResizeVolumeRequest
	(*ResizeVolumeResponse)(nil),             // 51: cloudstack.management.volume.v1.ResizeVolumeResponse
	(*ResizeVolumeCmdByAdminRequest)(nil),    // 52: cloudstack.management.volume.v1.ResizeVolumeCmdByAdminRequest
	(*ResizeVolumeCmdByAdminResponse)(nil),   // 53: cloudstack.management.volume.v1.ResizeVolumeCmdByAdminResponse
	(*UnmanageVolumeRequest)(nil),            // 54: cloudstack.management.volume.v1.UnmanageVolumeRequest
	(*UnmanageVolumeResponse)(nil),           // 55: cloudstack.management.volume.v1.UnmanageVolumeResponse
	(*UpdateVolumeRequest)(nil),              // 56: cloudstack.management.volume.v1.UpdateVolumeRequest
	(*UpdateVolumeResponse)(nil),             // 57: cloudstack.management.volume.v1.UpdateVolumeResponse
	(*UpdateVolumeCmdByAdminRequest)(nil),    // 58: cloudstack.management.volume.v1.UpdateVolumeCmdByAdminRequest
	(*UpdateVolumeCmdByAdminResponse)(nil),   // 59: cloudstack.management.volume.v1.UpdateVolumeCmdByAdminResponse
	(*UploadVolumeRequest)(nil),              // 60: cloudstack.management.volume.v1.UploadVolumeRequest
	(*UploadVolumeResponse)(nil),             // 61: cloudstack.management.volume.v1.UploadVolumeResponse
	(*UploadVolumeCmdByAdminRequest)(nil),    // 62: cloudstack.management.volume.v1.UploadVolumeCmdByAdminRequest
	(*UploadVolumeCmdByAdminResponse)(nil),   // 63: cloudstack.management.volume.v1.UploadVolumeCmdByAdminResponse
	(*ResourceTag)(nil),                      // 64: cloudstack.management.volume.v1.ResourceTag
	(*Volume)(nil),                           // 65: cloudstack.management.volume.v1.Volume
	(*VolumeForImport)(nil),                  // 66: cloudstack.management.volume.v1.VolumeForImport
	(*Success)(nil),                          // 67: cloudstack.management.volume.v1.Success
	(*Result)(nil),                           // 68: cloudstack.management.volume.v1.Result
	nil,                                      // 69: cloudstack.management.volume.v1.AddResourceDetailRequest.DetailsEntry
	nil,                                      // 70: cloudstack.management.volume.v1.ListVolumesRequest.TagsEntry
	nil,                                      // 71: cloudstack.management.volume.v1.ListVolumesCmdByAdminRequest.TagsEntry
}
var file_cloudstack_management_volume_v1_volume_gen_proto_depIdxs = []int32{
	69, // 0: cloudstack.management.volume.v1.AddResourceDetailRequest.details:type_name -> cloudstack.management.volume.v1.AddResourceDetailRequest.DetailsEntry
	68, // 1: cloudstack.management.volume.v1.AddResourceDetailResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 2: cloudstack.management.volume.v1.AssignVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 3: cloudstack.management.volume.v1.AttachVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 4: cloudstack.management.volume.v1.AttachVolumeCmdByAdminResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 5: cloudstack.management.volume.v1.ChangeOfferingForVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 6: cloudstack.management.volume.v1.CheckAndRepairVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 7: cloudstack.management.volume.v1.CreateVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 8: cloudstack.management.volume.v1.CreateVolumeCmdByAdminResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 9: cloudstack.management.volume.v1.DeleteVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 10: cloudstack.management.volume.v1.DestroyVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 11: cloudstack.management.volume.v1.DestroyVolumeCmdByAdminResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 12: cloudstack.management.volume.v1.DetachVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 13: cloudstack.management.volume.v1.DetachVolumeCmdByAdminResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 14: cloudstack.management.volume.v1.ExtractVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 15: cloudstack.management.volume.v1.GetUploadParamsForVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 16: cloudstack.management.volume.v1.ImportVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	64, // 17: cloudstack.management.volume.v1.ListResourceDetailsResponse.items:type_name -> cloudstack.management.volume.v1.ResourceTag
	70, // 18: cloudstack.management.volume.v1.ListVolumesRequest.tags:type_name -> cloudstack.management.volume.v1.ListVolumesRequest.TagsEntry
	65, // 19: cloudstack.management.volume.v1.ListVolumesResponse.items:type_name -> cloudstack.management.volume.v1.Volume
	71, // 20: cloudstack.management.volume.v1.ListVolumesCmdByAdminRequest.tags:type_name -> cloudstack.management.volume.v1.ListVolumesCmdByAdminRequest.TagsEntry
	65, // 21: cloudstack.management.volume.v1.ListVolumesCmdByAdminResponse.items:type_name -> cloudstack.management.volume.v1.Volume
	66, // 22: cloudstack.management.volume.v1.ListVolumesForImportResponse.items:type_name -> cloudstack.management.volume.v1.VolumeForImport
	68, // 23: cloudstack.management.volume.v1.MigrateVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 24: cloudstack.management.volume.v1.MigrateVolumeCmdByAdminResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 25: cloudstack.management.volume.v1.RecoverVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 26: cloudstack.management.volume.v1.RecoverVolumeCmdByAdminResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 27: cloudstack.management.volume.v1.RemoveResourceDetailResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 28: cloudstack.management.volume.v1.ResizeVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 29: cloudstack.management.volume.v1.ResizeVolumeCmdByAdminResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 30: cloudstack.management.volume.v1.UnmanageVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 31: cloudstack.management.volume.v1.UpdateVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 32: cloudstack.management.volume.v1.UpdateVolumeCmdByAdminResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 33: cloudstack.management.volume.v1.UploadVolumeResponse.result:type_name -> cloudstack.management.volume.v1.Result
	68, // 34: cloudstack.management.volume.v1.UploadVolumeCmdByAdminResponse.result:type_name -> cloudstack.management.volume.v1.Result
	0,  // 35: cloudstack.management.volume.v1.VolumeService.AddResourceDetail:input_type -> cloudstack.management.volume.v1.AddResourceDetailRequest
	2,  // 36: cloudstack.management.volume.v1.VolumeService.AssignVolume:input_type -> cloudstack.management.volume.v1.AssignVolumeRequest
	4,  // 37: cloudstack.management.volume.v1.VolumeService.AttachVolume:input_type -> cloudstack.management.volume.v1.AttachVolumeRequest
	6,  // 38: cloudstack.management.volume.v1.VolumeService.AttachVolumeCmdByAdmin:input_type -> cloudstack.management.volume.v1.AttachVolumeCmdByAdminRequest
	8,  // 39: cloudstack.management.volume.v1.VolumeService.ChangeOfferingForVolume:input_type -> cloudstack.management.volume.v1.ChangeOfferingForVolumeRequest
	10, // 40: cloudstack.management.volume.v1.VolumeService.CheckAndRepairVolume:input_type -> cloudstack.management.volume.v1.CheckAndRepairVolumeRequest
	12, // 41: cloudstack.management.volume.v1.VolumeService.CreateVolume:input_type -> cloudstack.management.volume.v1.CreateVolumeRequest
	14, // 42: cloudstack.management.volume.v1.VolumeService.CreateVolumeCmdByAdmin:input_type -> cloudstack.management.volume.v1.CreateVolumeCmdByAdminRequest
	16, // 43: cloudstack.management.volume.v1.VolumeService.DeleteVolume:input_type -> cloudstack.management.volume.v1.DeleteVolumeRequest
	18, // 44: cloudstack.management.volume.v1.VolumeService.DestroyVolume:input_type -> cloudstack.management.volume.v1.DestroyVolumeRequest
	20, // 45: cloudstack.management.volume.v1.VolumeService.DestroyVolumeCmdByAdmin:input_type -> cloudstack.management.volume.v1.DestroyVolumeCmdByAdminRequest
	22, // 46: cloudstack.management.volume.v1.VolumeService.DetachVolume:input_type -> cloudstack.management.volume.v1.DetachVolumeRequest
	24, // 47: cloudstack.management.volume.v1.VolumeService.DetachVolumeCmdByAdmin:input_type -> cloudstack.management.volume.v1.DetachVolumeCmdByAdminRequest
	26, // 48: cloudstack.management.volume.v1.VolumeService.ExtractVolume:input_type -> cloudstack.management.volume.v1.ExtractVolumeRequest
	28, // 49: cloudstack.management.volume.v1.VolumeService.GetUploadParamsForVolume:input_type -> cloudstack.management.volume.v1.GetUploadParamsForVolumeRequest
	30, // 50: cloudstack.management.volume.v1.VolumeService.ImportVolume:input_type -> cloudstack.management.volume.v1.ImportVolumeRequest
	32, // 51: cloudstack.management.volume.v1.VolumeService.ListResourceDetails:input_type -> cloudstack.management.volume.v1.ListResourceDetailsRequest
	34, // 52: cloudstack.management.volume.v1.VolumeService.ListVolumes:input_type -> cloudstack.management.volume.v1.ListVolumesRequest
	36, // 53: cloudstack.management.volume.v1.VolumeService.ListVolumesCmdByAdmin:input_type -> cloudstack.management.volume.v1.ListVolumesCmdByAdminRequest
	38, // 54: cloudstack.management.volume.v1.VolumeService.ListVolumesForImport:input_type -> cloudstack.management.volume.v1.ListVolumesForImportRequest
	40, // 55: cloudstack.management.volume.v1.VolumeService.MigrateVolume:input_type -> cloudstack.management.volume.v1.MigrateVolumeRequest
	42, // 56: cloudstack.management.volume.v1.VolumeService.MigrateVolumeCmdByAdmin:input_type -> cloudstack.management.volume.v1.MigrateVolumeCmdByAdminRequest
	44, // 57: cloudstack.management.volume.v1.VolumeService.RecoverVolume:input_type -> cloudstack.management.volume.v1.RecoverVolumeRequest
	46, // 58: cloudstack.management.volume.v1.VolumeService.RecoverVolumeCmdByAdmin:input_type -> cloudstack.management.volume.v1.RecoverVolumeCmdByAdminRequest
	48, // 59: cloudstack.management.volume.v1.VolumeService.RemoveResourceDetail:input_type -> cloudstack.management.volume.v1.RemoveResourceDetailRequest
	50, // 60: cloudstack.management.volume.v1.VolumeService.ResizeVolume:input_type -> cloudstack.management.volume.v1.ResizeVolumeRequest
	52, // 61: cloudstack.management.volume.v1.VolumeService.ResizeVolumeCmdByAdmin:input_type -> cloudstack.management.volume.v1.ResizeVolumeCmdByAdminRequest
	54, // 62: cloudstack.management.volume.v1.VolumeService.UnmanageVolume:input_type -> cloudstack.management.volume.v1.UnmanageVolumeRequest
	56, // 63: cloudstack.management.volume.v1.VolumeService.UpdateVolume:input_type -> cloudstack.management.volume.v1.UpdateVolumeRequest
	58, // 64: cloudstack.management.volume.v1.VolumeService.UpdateVolumeCmdByAdmin:input_type -> cloudstack.management.volume.v1.UpdateVolumeCmdByAdminRequest
	60, // 65: cloudstack.management.volume.v1.VolumeService.UploadVolume:input_type -> cloudstack.management.volume.v1.UploadVolumeRequest
	62, // 66: cloudstack.management.volume.v1.VolumeService.UploadVolumeCmdByAdmin:input_type -> cloudstack.management.volume.v1.UploadVolumeCmdByAdminRequest
	1,  // 67: cloudstack.management.volume.v1.VolumeService.AddResourceDetail:output_type -> cloudstack.management.volume.v1.AddResourceDetailResponse
	3,  // 68: cloudstack.management.volume.v1.VolumeService.AssignVolume:output_type -> cloudstack.management.volume.v1.AssignVolumeResponse
	5,  // 69: cloudstack.management.volume.v1.VolumeService.AttachVolume:output_type -> cloudstack.management.volume.v1.AttachVolumeResponse
	7,  // 70: cloudstack.management.volume.v1.VolumeService.AttachVolumeCmdByAdmin:output_type -> cloudstack.management.volume.v1.AttachVolumeCmdByAdminResponse
	9,  // 71: cloudstack.management.volume.v1.VolumeService.ChangeOfferingForVolume:output_type -> cloudstack.management.volume.v1.ChangeOfferingForVolumeResponse
	11, // 72: cloudstack.management.volume.v1.VolumeService.CheckAndRepairVolume:output_type -> cloudstack.management.volume.v1.CheckAndRepairVolumeResponse
	13, // 73: cloudstack.management.volume.v1.VolumeService.CreateVolume:output_type -> cloudstack.management.volume.v1.CreateVolumeResponse
	15, // 74: cloudstack.management.volume.v1.VolumeService.CreateVolumeCmdByAdmin:output_type -> cloudstack.management.volume.v1.CreateVolumeCmdByAdminResponse
	17, // 75: cloudstack.management.volume.v1.VolumeService.DeleteVolume:output_type -> cloudstack.management.volume.v1.DeleteVolumeResponse
	19, // 76: cloudstack.management.volume.v1.VolumeService.DestroyVolume:output_type -> cloudstack.management.volume.v1.DestroyVolumeResponse
	21, // 77: cloudstack.management.volume.v1.VolumeService.DestroyVolumeCmdByAdmin:output_type -> cloudstack.management.volume.v1.DestroyVolumeCmdByAdminResponse
	23, // 78: cloudstack.management.volume.v1.VolumeService.DetachVolume:output_type -> cloudstack.management.volume.v1.DetachVolumeResponse
	25, // 79: cloudstack.management.volume.v1.VolumeService.DetachVolumeCmdByAdmin:output_type -> cloudstack.management.volume.v1.DetachVolumeCmdByAdminResponse
	27, // 80: cloudstack.management.volume.v1.VolumeService.ExtractVolume:output_type -> cloudstack.management.volume.v1.ExtractVolumeResponse
	29, // 81: cloudstack.management.volume.v1.VolumeService.GetUploadParamsForVolume:output_type -> cloudstack.management.volume.v1.GetUploadParamsForVolumeResponse
	31, // 82: cloudstack.management.volume.v1.VolumeService.ImportVolume:output_type -> cloudstack.management.volume.v1.ImportVolumeResponse
	33, // 83: cloudstack.management.volume.v1.VolumeService.ListResourceDetails:output_type -> cloudstack.management.volume.v1.ListResourceDetailsResponse
	35, // 84: cloudstack.management.volume.v1.VolumeService.ListVolumes:output_type -> cloudstack.management.volume.v1.ListVolumesResponse
	37, // 85: cloudstack.management.volume.v1.VolumeService.ListVolumesCmdByAdmin:output_type -> cloudstack.management.volume.v1.ListVolumesCmdByAdminResponse
	39, // 86: cloudstack.management.volume.v1.VolumeService.ListVolumesForImport:output_type -> cloudstack.management.volume.v1.ListVolumesForImportResponse
	41, // 87: cloudstack.management.volume.v1.VolumeService.MigrateVolume:output_type -> cloudstack.management.volume.v1.MigrateVolumeResponse
	43, // 88: cloudstack.management.volume.v1.VolumeService.MigrateVolumeCmdByAdmin:output_type -> cloudstack.management.volume.v1.MigrateVolumeCmdByAdminResponse
	45, // 89: cloudstack.management.volume.v1.VolumeService.RecoverVolume:output_type -> cloudstack.management.volume.v1.RecoverVolumeResponse
	47, // 90: cloudstack.management.volume.v1.VolumeService.RecoverVolumeCmdByAdmin:output_type -> cloudstack.management.volume.v1.RecoverVolumeCmdByAdminResponse
	49, // 91: cloudstack.management.volume.v1.VolumeService.RemoveResourceDetail:output_type -> cloudstack.management.volume.v1.RemoveResourceDetailResponse
	51, // 92: cloudstack.management.volume.v1.VolumeService.ResizeVolume:output_type -> cloudstack.management.volume.v1.ResizeVolumeResponse
	53, // 93: cloudstack.management.volume.v1.VolumeService.ResizeVolumeCmdByAdmin:output_type -> cloudstack.management.volume.v1.ResizeVolumeCmdByAdminResponse
	55, // 94: cloudstack.management.volume.v1.VolumeService.UnmanageVolume:output_type -> cloudstack.management.volume.v1.UnmanageVolumeResponse
	57, // 95: cloudstack.management.volume.v1.VolumeService.UpdateVolume:output_type -> cloudstack.management.volume.v1.UpdateVolumeResponse
	59, // 96: cloudstack.management.volume.v1.VolumeService.UpdateVolumeCmdByAdmin:output_type -> cloudstack.management.volume.v1.UpdateVolumeCmdByAdminResponse
	61, // 97: cloudstack.management.volume.v1.VolumeService.UploadVolume:output_type -> cloudstack.management.volume.v1.UploadVolumeResponse
	63, // 98: cloudstack.management.volume.v1.VolumeService.UploadVolumeCmdByAdmin:output_type -> cloudstack.management.volume.v1.UploadVolumeCmdByAdminResponse
