...
const file_cloudstack_management_usage_v1_usage_gen_proto_rawDesc = "" +
	...
	"\x06result\x18\x01 \x01(\v2&.cloudstack.management.usage.v1.ResultR\x06result\"\x97\x01\n" +
	"\bProvider\x12\x18\n" +
	...
	"\n" +
	"job_status\x18\x05 \x01(\tR\tjobStatus2\xb1\x0e\n" +
	"\fUsageService\x12\x91\x01\n" +
	"\x11AddTrafficMonitor\x128.cloudstack.management.usage.v1.AddTrafficMonitorRequest\x1a9.cloudstack.management.usage.v1.AddTrafficMonitorResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x88\x01\n" +
	"\x0eAddTrafficType\x125.cloudstack.management.usage.v1.AddTrafficTypeRequest\x1a6.cloudstack.management.usage.v1.AddTrafficTypeResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x9a\x01\n" +
	"\x14DeleteTrafficMonitor\x12;.cloudstack.management.usage.v1.DeleteTrafficMonitorRequest\x1a<.cloudstack.management.usage.v1.DeleteTrafficMonitorResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x91\x01\n" +
	"\x11DeleteTrafficType\x128.cloudstack.management.usage.v1.DeleteTrafficTypeRequest\x1a9.cloudstack.management.usage.v1.DeleteTrafficTypeResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x9a\x01\n" +
	"\x14GenerateUsageRecords\x12;.cloudstack.management.usage.v1.GenerateUsageRecordsRequest\x1a<.cloudstack.management.usage.v1.GenerateUsageRecordsResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x97\x01\n" +
	"\x13ListTrafficMonitors\x12:.cloudstack.management.usage.v1.ListTrafficMonitorsRequest\x1a;.cloudstack.management.usage.v1.ListTrafficMonitorsResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\xaf\x01\n" +
	"\x1bListTrafficTypeImplementors\x12B.cloudstack.management.usage.v1.ListTrafficTypeImplementorsRequest\x1aC.cloudstack.management.usage.v1.ListTrafficTypeImplementorsResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x8e\x01\n" +
	"\x10ListTrafficTypes\x127.cloudstack.management.usage.v1.ListTrafficTypesRequest\x1a8.cloudstack.management.usage.v1.ListTrafficTypesResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x8e\x01\n" +
	"\x10ListUsageRecords\x127.cloudstack.management.usage.v1.ListUsageRecordsRequest\x1a8.cloudstack.management.usage.v1.ListUsageRecordsResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x88\x01\n" +
	"\x0eListUsageTypes\x125.cloudstack.management.usage.v1.ListUsageTypesRequest\x1a6.cloudstack.management.usage.v1.ListUsageTypesResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x9d\x01\n" +
	"\x15RemoveRawUsageRecords\x12<.cloudstack.management.usage.v1.RemoveRawUsageRecordsRequest\x1a=.cloudstack.management.usage.v1.RemoveRawUsageRecordsResponse\"\a\xc2>\x04\xc2>\x01\x02\x12\x91\x01\n" +
	"\x11UpdateTrafficType\x128.cloudstack.management.usage.v1.UpdateTrafficTypeRequest\x1a9.cloudstack.management.usage.v1.UpdateTrafficTypeResponse\"\a\xc2>\x04\xc2>\x01\x02\x1a\a\xc2>\x04\xc2>\x01\x02B\xaa\x02\n" +
...
var file_cloudstack_management_usage_v1_usage_gen_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_cloudstack_management_usage_v1_usage_gen_proto_goTypes = []any{
	(*AddTrafficMonitorRequest)(nil),            // 0: cloudstack.management.usage.v1.AddTrafficMonitorRequest
	(*AddTrafficMonitorResponse)(nil),           // 1: cloudstack.management.usage.v1.AddTrafficMonitorResponse
	(*AddTrafficTypeRequest)(nil),               // 2: cloudstack.management.usage.v1.AddTrafficTypeRequest
	(*AddTrafficTypeResponse)(nil),              // 3: cloudstack.management.usage.v1.AddTrafficTypeResponse
	(*DeleteTrafficMonitorRequest)(nil),         // 4: cloudstack.management.usage.v1.DeleteTrafficMonitorRequest
	(*DeleteTrafficMonitorResponse)(nil),        // 5: cloudstack.management.usage.v1.DeleteTrafficMonitorResponse
	(*DeleteTrafficTypeRequest)(nil),            // 6: cloudstack.management.usage.v1.DeleteTrafficTypeRequest
	(*DeleteTrafficTypeResponse)(nil),           // 7: cloudstack.management.usage.v1.DeleteTrafficTypeResponse
	(*GenerateUsageRecordsRequest)(nil),         // 8: cloudstack.management.usage.v1.GenerateUsageRecordsRequest
	(*GenerateUsageRecordsResponse)(nil),        // 9: cloudstack.management.usage.v1.GenerateUsageRecordsResponse
	(*ListTrafficMonitorsRequest)(nil),          // 10: cloudstack.management.usage.v1.ListTrafficMonitorsRequest
	(*ListTrafficMonitorsResponse)(nil),         // 11: cloudstack.management.usage.v1.ListTrafficMonitorsResponse
	(*ListTrafficTypeImplementorsRequest)(nil),  // 12: cloudstack.management.usage.v1.ListTrafficTypeImplementorsRequest
	(*ListTrafficTypeImplementorsResponse)(nil), // 13: cloudstack.management.usage.v1.ListTrafficTypeImplementorsResponse
	(*ListTrafficTypesRequest)(nil),             // 14: cloudstack.management.usage.v1.ListTrafficTypesRequest
	(*ListTrafficTypesResponse)(nil),            // 15: cloudstack.management.usage.v1.ListTrafficTypesResponse
	(*ListUsageRecordsRequest)(nil),             // 16: cloudstack.management.usage.v1.ListUsageRecordsRequest
	(*ListUsageRecordsResponse)(nil),            // 17: cloudstack.management.usage.v1.ListUsageRecordsResponse
	(*ListUsageTypesRequest)(nil),               // 18: cloudstack.management.usage.v1.ListUsageTypesRequest
	(*ListUsageTypesResponse)(nil),              // 19: cloudstack.management.usage.v1.ListUsageTypesResponse
	(*RemoveRawUsageRecordsRequest)(nil),        // 20: cloudstack.management.usage.v1.RemoveRawUsageRecordsRequest
	(*RemoveRawUsageRecordsResponse)(nil),       // 21: cloudstack.management.usage.v1.RemoveRawUsageRecordsResponse
	(*UpdateTrafficTypeRequest)(nil),            // 22: cloudstack.management.usage.v1.UpdateTrafficTypeRequest
	(*UpdateTrafficTypeResponse)(nil),           // 23: cloudstack.management.usage.v1.UpdateTrafficTypeResponse
	(*Provider)(nil),                            // 24: cloudstack.management.usage.v1.Provider
	(*TrafficMonitor)(nil),                      // 25: cloudstack.management.usage.v1.TrafficMonitor
	...
	(*Result)(nil),                              // 30: cloudstack.management.usage.v1.Result
}
var file_cloudstack_management_usage_v1_usage_gen_proto_depIdxs = []int32{
	30, // 0: cloudstack.management.usage.v1.AddTrafficMonitorResponse.result:type_name -> cloudstack.management.usage.v1.Result
	30, // 1: cloudstack.management.usage.v1.AddTrafficTypeResponse.result:type_name -> cloudstack.management.usage.v1.Result
	30, // 2: cloudstack.management.usage.v1.DeleteTrafficMonitorResponse.result:type_name -> cloudstack.management.usage.v1.Result
	30, // 3: cloudstack.management.usage.v1.DeleteTrafficTypeResponse.result:type_name -> cloudstack.management.usage.v1.Result
	30, // 4: cloudstack.management.usage.v1.GenerateUsageRecordsResponse.result:type_name -> cloudstack.management.usage.v1.Result
	25, // 5: cloudstack.management.usage.v1.ListTrafficMonitorsResponse.items:type_name -> cloudstack.management.usage.v1.TrafficMonitor
	26, // 6: cloudstack.management.usage.v1.ListTrafficTypeImplementorsResponse.items:type_name -> cloudstack.management.usage.v1.TrafficTypeImplementor
	24, // 7: cloudstack.management.usage.v1.ListTrafficTypesResponse.items:type_name -> cloudstack.management.usage.v1.Provider
	27, // 8: cloudstack.management.usage.v1.ListUsageRecordsResponse.items:type_name -> cloudstack.management.usage.v1.UsageRecord
	28, // 9: cloudstack.management.usage.v1.ListUsageTypesResponse.items:type_name -> cloudstack.management.usage.v1.UsageType
	30, // 10: cloudstack.management.usage.v1.RemoveRawUsageRecordsResponse.result:type_name -> cloudstack.management.usage.v1.Result
	30, // 11: cloudstack.management.usage.v1.UpdateTrafficTypeResponse.result:type_name -> cloudstack.management.usage.v1.Result
	0,  // 12: cloudstack.management.usage.v1.UsageService.AddTrafficMonitor:input_type -> cloudstack.management.usage.v1.AddTrafficMonitorRequest
	2,  // 13: cloudstack.management.usage.v1.UsageService.AddTrafficType:input_type -> cloudstack.management.usage.v1.AddTrafficTypeRequest
	4,  // 14: cloudstack.management.usage.v1.UsageService.DeleteTrafficMonitor:input_type -> cloudstack.management.usage.v1.DeleteTrafficMonitorRequest
	6,  // 15: cloudstack.management.usage.v1.UsageService.DeleteTrafficType:input_type -> cloudstack.management.usage.v1.DeleteTrafficTypeRequest
	8,  // 16: cloudstack.management.usage.v1.UsageService.GenerateUsageRecords:input_type -> cloudstack.management.usage.v1.GenerateUsageRecordsRequest
	10, // 17: cloudstack.management.usage.v1.UsageService.ListTrafficMonitors:input_type -> cloudstack.management.usage.v1.ListTrafficMonitorsRequest
	12, // 18: cloudstack.management.usage.v1.UsageService.ListTrafficTypeImplementors:input_type -> cloudstack.management.usage.v1.ListTrafficTypeImplementorsRequest
	14, // 19: cloudstack.management.usage.v1.UsageService.ListTrafficTypes:input_type -> cloudstack.management.usage.v1.ListTrafficTypesRequest
	16, // 20: cloudstack.management.usage.v1.UsageService.ListUsageRecords:input_type -> cloudstack.management.usage.v1.ListUsageRecordsRequest
	18, // 21: cloudstack.management.usage.v1.UsageService.ListUsageTypes:input_type -> cloudstack.management.usage.v1.ListUsageTypesRequest
	20, // 22: cloudstack.management.usage.v1.UsageService.RemoveRawUsageRecords:input_type -> cloudstack.management.usage.v1.RemoveRawUsageRecordsRequest
	22, // 23: cloudstack.management.usage.v1.UsageService.UpdateTrafficType:input_type -> cloudstack.management.usage.v1.UpdateTrafficTypeRequest
	1,  // 24: cloudstack.management.usage.v1.UsageService.AddTrafficMonitor:output_type -> cloudstack.management.usage.v1.AddTrafficMonitorResponse
	3,  // 25: cloudstack.management.usage.v1.UsageService.AddTrafficType:output_type -> cloudstack.management.usage.v1.AddTrafficTypeResponse
	5,  // 26: cloudstack.management.usage.v1.UsageService.DeleteTrafficMonitor:output_type -> cloudstack.management.usage.v1.DeleteTrafficMonitorResponse
	7,  // 27: cloudstack.management.usage.v1.UsageService.DeleteTrafficType:output_type -> cloudstack.management.usage.v1.DeleteTrafficTypeResponse
	9,  // 28: cloudstack.management.usage.v1.UsageService.GenerateUsageRecords:output_type -> cloudstack.management.usage.v1.GenerateUsageRecordsResponse
	11, // 29: cloudstack.management.usage.v1.UsageService.ListTrafficMonitors:output_type -> cloudstack.management.usage.v1.ListTrafficMonitorsResponse
	13, // 30: cloudstack.management.usage.v1.UsageService.ListTrafficTypeImplementors:output_type -> cloudstack.management.usage.v1.ListTrafficTypeImplementorsResponse
	15, // 31: cloudstack.management.usage.v1.UsageService.ListTrafficTypes:output_type -> cloudstack.management.usage.v1.ListTrafficTypesResponse
	17, // 32: cloudstack.management.usage.v1.UsageService.ListUsageRecords:output_type -> cloudstack.management.usage.v1.ListUsageRecordsResponse
	19, // 33: cloudstack.management.usage.v1.UsageService.ListUsageTypes:output_type -> cloudstack.management.usage.v1.ListUsageTypesResponse
	21, // 34: cloudstack.management.usage.v1.UsageService.RemoveRawUsageRecords:output_type -> cloudstack.management.usage.v1.RemoveRawUsageRecordsResponse
	23, // 35: cloudstack.management.usage.v1.UsageService.UpdateTrafficType:output_type -> cloudstack.management.usage.v1.UpdateTrafficTypeResponse
