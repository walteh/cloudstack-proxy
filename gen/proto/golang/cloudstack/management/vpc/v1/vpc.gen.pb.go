...
const file_cloudstack_management_vpc_v1_vpc_gen_proto_rawDesc = "" +
	...
	"\x05state\x18\b \x01(\tR\x05state\x120\n" +
	"\x10restart_required\x18\t \x01(\bB\x05\xaa\x01\x02\b\x01R\x0frestartRequired\x12\x1f\n" +
	"\adisplay\x18\n" +
	...
	"\x06result\x18\x01 \x01(\v2$.cloudstack.management.vpc.v1.ResultR\x06result\"\xd2\x03\n" +
	...
	"\x05state\x18\t \x01(\tR\x05state\x120\n" +
	...
	"\adetails\x18\f \x03(\v2/.cloudstack.management.vpc.v1.Item.DetailsEntryR\adetails\x1a:\n" +
