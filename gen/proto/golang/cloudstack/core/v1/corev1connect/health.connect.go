...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/walteh/cloudstack-proxy/gen/proto/golang/cloudstack/core/v1"
	http "net/http"
	strings "strings"
)
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_cloudstack_core_v1_health_proto.Services().ByName("HealthService").Methods()
